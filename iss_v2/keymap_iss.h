...
/*
 * Rotate 90 degrees here to match hardware layout
 */
#define KEYMAP( \
    ...
    { KC_##K0F, KC_##K1F, KC_##K2F, KC_##K3F, KC_##K4F, KC_##K5F }, \
    { KC_NO,    KC_##K1E, KC_##K2E, KC_NO,    KC_NO,    KC_##K5E }, \
    { KC_##K0D, KC_##K1D, KC_NO,    KC_##K3D, KC_NO,    KC_##K5D }, \
    { KC_##K0C, KC_##K1C, KC_##K2C, KC_##K3C, KC_##K4C, KC_##K5C }, \
    { KC_##K0B, KC_##K1B, KC_##K2B, KC_##K3B, KC_##K4B, KC_NO    }, \
    { KC_##K0A, KC_##K1A, KC_##K2A, KC_##K3A, KC_##K4A, KC_##K5A }, \
    { KC_##K09, KC_##K19, KC_##K29, KC_##K39, KC_##K49, KC_##K59 }, \
    { KC_##K08, KC_##K18, KC_##K28, KC_##K38, KC_##K48, KC_NO    }, \
    { KC_##K07, KC_##K17, KC_##K27, KC_##K37, KC_##K47, KC_NO    }, \
    { KC_##K06, KC_##K16, KC_##K26, KC_##K36, KC_##K46, KC_##K56 }, \
    { KC_##K05, KC_##K15, KC_##K25, KC_##K35, KC_##K45, KC_NO    }, \
    { KC_##K04, KC_##K14, KC_##K24, KC_##K34, KC_##K44, KC_NO    }, \
    { KC_##K03, KC_##K13, KC_##K23, KC_##K33, KC_##K43, KC_NO    }, \
    { KC_##K02, KC_##K12, KC_##K22, KC_##K32, KC_##K42, KC_##K52 }, \
    { KC_NO,    KC_##K11, KC_##K21, KC_##K31, KC_##K41, KC_##K51 }, \
